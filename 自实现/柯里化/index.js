...
// todo 如何实现一个无限累加的 sum 函数
// const res1 = sum(1, 2, 3).valueOf(); //6
// const res2 = sum(2, 3)(2).valueOf(); //7
// const res3 = sum(1)(2)(3)(4).valueOf(); //10
// const res4 = sum(2)(4, 1)(2).valueOf(); //9
// const res5 = sum(1)(2)(3)(4)(5)(6).valueOf(); // 21
