...
7.  [addEventListener 的 type 有哪些](https://developer.mozilla.org/zh-CN/docs/Web/Events)
    1.  鼠标事件
        1.  click
        2.  dblclick
        3.  mousedown
...
11. useEffect 和 useLayoutEffect 区别
    1. react 渲染分为两个阶段：
       1. render: vdom => fiber
       2. commit: (0. effect 遍历执行 调度，调度后 具体的回调是同步/异步执行)
          1. before mutation
          2. mutation // 操作 dom
          3. layout // 之后 useLayoutEffect 同步执行, useEffect 异步执行
