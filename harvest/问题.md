...
14. [object-fit: ](https://developer.mozilla.org/zh-CN/docs/Web/CSS/object-fit)图片在固定宽高范围内进行剪切,保持原始比例
15. [outline](https://developer.mozilla.org/zh-CN/docs/Web/CSS/outline)
    ...
    ```
16. 默认定义在后面的样式会覆盖定义在前面的，与使用时的位置无关(位置: ./interviews/demo/css.html)
