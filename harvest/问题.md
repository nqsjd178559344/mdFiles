...
3.  [Observer]('https://mp.weixin.qq.com/s/c3sYhwrunLqCRfPI9ZCzOg')
    ...
    1.  IntersectionObserver 监听元素可见性更改
        ...
        ````tsx
          export const useFontSize = () => {
              const [fontSize, setFontSize] = useState(() => {
                return document.getElementById('A')!.style.getPropertyValue('--font-size');
              });
              useEffect(() => {
                ...
                mutationObserver = new MutationObserver(
                  debounce(
                    (mutationList) => {
                      const fontSize = mutationList[0].target.style.getPropertyValue('--font-size');
...
14. [object-fit](https://developer.mozilla.org/zh-CN/docs/Web/CSS/object-fit)
15. [outline](https://developer.mozilla.org/zh-CN/docs/Web/CSS/outline)
16. width:-webkit-fill-available;
